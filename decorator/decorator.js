...
var EnhancendAutoPilot = /** @class */ (function (_super) {
    __extends(EnhancendAutoPilot, _super);
    function EnhancendAutoPilot(car) {
        var _this = _super.call(this) || this;
        _this.decoratedCar = car;
        return _this;
    }
    EnhancendAutoPilot.prototype.getDescription = function () {
        return this.decoratedCar.getDescription() + ", Enhanced AutoPilot";
    };
    EnhancendAutoPilot.prototype.cost = function () {
        return this.decoratedCar.cost() + 5000;
    };
    return EnhancendAutoPilot;
}(CarOptions));
